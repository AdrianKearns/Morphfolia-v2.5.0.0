<%@ Page Language="C#" MasterPageFile="~/Morphfolia/_publishing/AdminMasterPage.master" AutoEventWireup="true" CodeFile="EventIds.aspx.cs" Inherits="Morphfolia__publishing_EventIds" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceholder" Runat="Server">
    <asp:Button ID="btnShowMorphOnly" runat="server" 
        onclick="btnShowMorphOnly_Click" Text="Morphfolia EventIds" 
