...
//{
//    internal partial class ControlPropertyTypeFactory
//    {
...
//    internal partial class ControlPropertyTypeConstants
//    {
...
//        internal partial class PropertyTypeDescriptions
//        {
        ...
        private void PopulateUIWithExistingValues(int contentId)
        {
            if (contentId > Morphfolia.Common.Constants.SystemTypeValues.NullInt)
            {
                ...
                if ((_ContentItem.ContentEntryFilter == string.Empty) | (_ContentItem.ContentEntryFilter.Equals(ContentEntryFilterHtmlEditorOptionValue)))
                {
                    ...
                    //txtEditor_MarkDown.Text = _ContentItem.Content;
            ...
            else
            {
                if (ddlContentEntryFilter.SelectedValue.Equals(ContentEntryFilterHtmlEditorOptionValue))
                {
                    ...
                    txtEditor_HTML.Text = string.Empty;
                    ToggleContentEntryFilterUI(false);
                    ddlContentEntryFilter.SelectedIndex = 0;
                }
                else
		...
		private int Save()
		{
			...
			if( this._ContentID == Morphfolia.Common.Constants.SystemTypeValues.NullInt )
			{
                ...
                if (ddlContentEntryFilter.SelectedItem.Value.Equals("HtmlEditor"))
                {
                    ...
                    SaveNewCustomPropertyInstanceInfo info = new SaveNewCustomPropertyInstanceInfo(
                        outputContentId, ControlPropertyTypeFactory.MarkDownContentPropertyType(), "MarkDownContent", txtEditor_MarkDown.Text);
			...
			else
			{
                ...
                if (ddlContentEntryFilter.SelectedItem.Value.Equals("HtmlEditor"))
                {
                    ...
                    SaveNewCustomPropertyInstanceInfo info = new SaveNewCustomPropertyInstanceInfo(
                        outputContentId, Common.ControlPropertyTypeFactory.MarkDownContentPropertyType(), "MarkDownContent", txtEditor_MarkDown.Text);
                    StaticCustomPropertyHelper.SaveControlPropertyByInstance(info);
                }
			}
