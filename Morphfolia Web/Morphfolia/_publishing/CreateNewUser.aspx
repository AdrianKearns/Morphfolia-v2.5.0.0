<%@ Page AutoEventWireup="true" CodeFile="CreateNewUser.aspx.cs" Inherits="_publishing_CreateNewUser"
    Language="C#" MasterPageFile="~/Morphfolia/_publishing/AdminMasterPage.master" Title="Create New User" %>
                ...
                <asp:CompleteWizardStep runat="server">
                    <ContentTemplate>
                        <table border="0">
                            ...
                            <tr>
                                <td>
                                    New account successfully created.</td>
                            </tr>
                            <tr>
                                <td align="right" colspan="2">
                                    <asp:Button ID="ContinueButton" runat="server" CausesValidation="False" CommandName="Continue"
                                        Text="Continue" ValidationGroup="CreateUserWizard1" OnClick="ContinueButton_Click" Visible="False" />
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
