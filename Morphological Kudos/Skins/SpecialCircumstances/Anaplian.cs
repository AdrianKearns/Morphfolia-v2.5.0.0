...
namespace Morphological.Kudos.Skins.SpecialCircumstances
{
    ...
    public class Anaplian : ISkinProvider
    {
        ...
        {
            return Morphological.Kudos.Skins.SpecialCircumstances.HeaderFactory.Make(AlertText, page.Title, BackgroundImageTop, BackgroundImageBottom, BackgroundColourTop, BackgroundColourBottom, CssClassTop, CssClassBottom, TopInlineStyle, BottomInlineStyle);
        }
