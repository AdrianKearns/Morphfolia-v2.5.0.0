...
namespace Morphfolia.PublishingSystem.HttpHandlers
{
    ...
    /// </summary>
    [IsHttpHandler("Serves a blog by it's URL, as a full HTML page.")]
    public class ViewBlogByUrl : IHttpHandler
    {
        ...
        */
        ...
        {
            using (Microsoft.Practices.EnterpriseLibrary.Logging.Tracer traceDefaultHandlerProcessRequest = new Microsoft.Practices.EnterpriseLibrary.Logging.Tracer(Morphfolia.Common.Logging.Categories.PublishingSystem, TraceGuids._3200))
            {
                Logger.LogVerboseInformation("Blog Request", httpContext.Request.Url.AbsoluteUri, Morphfolia.PublishingSystem.Logging.EventIds._3200);
                ...
                try
                {
                    ...
                    Business.Blogging.Blog currentBlog = Business.Blogging.BlogFactory.ByUrl(derivedPageUrl);



                    Logger.LogVerboseInformation("Blog Request",
                    ...
                    if (pageLayout is Layouts.BlogPageLayout)
                    {
                        ...
                        bpl.CurrentPost = currentBlog.GetLatestBlogPost();
