...
/****** Object:  Stored Procedure dbo.HttpLog_SELECT_ReferreringUrlsForVisitedUrlByDateRange    Script Date: 2/09/2007 3:19:29 p.m. ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[HttpLog_SELECT_ReferreringUrlsForVisitedUrlByDateRange]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[HttpLog_SELECT_ReferreringUrlsForVisitedUrlByDateRange]
GO
...
CREATE Procedure HttpLog_SELECT_ReferreringUrlsForVisitedUrlByDateRange
